...
export const CATEGORIAS_ITENS = [
  {
    ...
    singleSelect: true,
    itens: [
      { id: 'cafe-colonial-premium', nome: 'Café Colonial Completo', descricao: 'Pães artesanais, bolos, frios, frutas e bebidas quentes', preco: 79.90 },
      { id: 'cafe-colonial', nome: 'Café Colonial Completo', descricao: 'Opção essencial com pães, bolos e bebidas quentes', preco: 59.90 },
      { id: 'brunch', nome: 'Brunch Especial', descricao: 'Opção sofisticada com pratos quentes e frios' },
      { id: 'coquetel-volante', nome: 'Coquetel Volante', descricao: 'Mini porções elegantes servidas pelos garçons' },
